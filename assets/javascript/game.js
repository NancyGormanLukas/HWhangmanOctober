window.onload = function() {
	...
	var userGuess;
	var words = ["jen", "rangy", "arnold", "nick", "julian", "stephen", "josie", "cristal", "amanda", "whitley", "karina", "travis", "frank", "todd", "yana", "kristin", "seth", "tom", "eli", "richard", "chen", "steven", "joshua", "tyler", "nancy", "sal", "hira"];
	var word = [];
	var positions = [];
	var guessedLetters = [];
	var guesses;
